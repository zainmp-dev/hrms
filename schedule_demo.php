...
<?php include 'header.php';?>
 <!-- Start Page Title Area -->
        ...
        <div class="contact-area ptb-100">
            <div class="container">
                <div class="section-title">
                    <h2>Get in Touch</h2>
                    <p>Leave Management to Unlock productivity and enhance efficiency using OfficeKit HR</p>
                </div>
      ...
      "
    >
      <h2 style="text-align: center; color: #333">Demo Registration</h2>
      ...
      <script>
        ...
        const handleSubmit = async (e) => {
          ...
          try {
            const response = await fetch(
              `${BASE_URL}?token=${token}&name=${name}&countrycode=${cuntryCode}&mobileno=${mobileno}&source=Demo&email=${email}&company_name=${company_name}`,
              {
                method: "POST",
                headers: {
        ...
        form.addEventListener("submit", handleSubmit);
                  ...
                  <!--  <form id="contactForm">
                    ...
                    <!--<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSf-F_u5GwqMDSST-IPV6BN9ZgUIAvSuNHjroNboeNcW0siMXQ/viewform?usp=sf_link" width="640" height="1100" frameborder="0" marginheight="0" marginwidth="0" scrolling="no">Loading…</iframe>
                    !-->
                </div>
